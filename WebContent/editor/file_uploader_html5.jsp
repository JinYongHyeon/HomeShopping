...
<%
	...
	if (cnt == 0) {
		...
		//파일 기본경로 _ 상세경로
		String filePath = dftFilePath + "resources" + File.separator + "img" + File.separator + "product" + File.separator+"content" + File.separator;
	...
	//	}
		...
		sFileInfo += "&sFileURL=/homeShopping/resources/img/product/content/"+realFileNm;
