...
public class PagingBean {
	...
	private int postCountPrePage = 10;// 페이지 당 게시물 수
	private int pageCountPerPageGroup = 5;// 그룹 당 페이지 수
	...
	public PagingBean(int nowPage, int totalRow) {
		super();
	...
	public int getTotalGroup() {
		return getTotalPage() % pageCountPerPageGroup == 0 ? getTotalPage() / pageCountPerPageGroup
				: getTotalPage() / pageCountPerPageGroup + 1;
	}

	// 현재 그룹
	public int getNowGroup() {
		return nowPage % pageCountPerPageGroup == 0 ? nowPage / pageCountPerPageGroup
				: nowPage / pageCountPerPageGroup + 1;
	}
	...
	public int getEndGroup() {
		return getNowGroup() * pageCountPerPageGroup > getTotalPage() ? getTotalPage()
				: getNowGroup() * pageCountPerPageGroup;
	}
